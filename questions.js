/* QUESTIONS & GAME MODES */
        ...
        function startGameWith(mode, op, customTable = null, forceTimer = false) {
            /* ══ 🔒 SERVER-SIDE LEVEL VALIDATION (تحقق من المستوى داخل الدالة) ══ */
            if (op === 'advanced' && st.level < 7)  { showFeedback('🔒 هذا القسم مقفول حتى المستوى 7');  return; }
            if (op === 'laws'     && st.level < 10) { showFeedback('🔒 هذا القسم مقفول حتى المستوى 10'); return; }
            /* ══════════════════════════════════════════════════════════════════ */
