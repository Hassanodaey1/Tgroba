...
/* ═══════════════════════════════════════════════════════
   overlay الألقاب الموسمية في صفحة المنافسة
   الصدارة تعتمد على لائحة لعبة التحدي فقط
═══════════════════════════════════════════════════════ */
...
function renderCompTitlesOverlay() {
    ...
    if (nextTitle) {
        ...
        if (nextTarget)   nextTarget.textContent = `الهدف التالي: ${nextTitle.name} (${nextTitle.daysRequired} يوم)`;
    } else {
...
/* تصدير للاستخدام من صفحة المنافسة */
