/* STATE */
        ...
        ═══════════════════════════════════════════════════════════ */
        const SEASON_NAMES = [
            'الموسم الأول — الأرقام الذهبية 🔢',
            'الموسم الثاني — المعادلات 🔮',
            'الموسم الثالث — الهندسة 📐',
            'الموسم الرابع — الكسور 🍕',
            'الموسم الخامس — الأسس والجذور √',
            'الموسم السادس — الإحصاء 📊',
            'الموسم السابع — الجبر 🔣',
            'الموسم الثامن — المنطق 🧠',
        ];
        ...
        function sanitizeState(s) {
            ...
            /* ── 💎 تنظيف الحصريات المنتهية ── */
            if (!Array.isArray(s._exclusiveItems)) s._exclusiveItems = [];
            s._exclusiveItems = s._exclusiveItems.filter(i =>
                i && typeof i.expiresAt === 'number' && i.expiresAt > Date.now()
            );
            if (!Array.isArray(s.ownedDiamondItems)) s.ownedDiamondItems = [];
            if (!s._permBoosts || typeof s._permBoosts !== 'object') s._permBoosts = {};
